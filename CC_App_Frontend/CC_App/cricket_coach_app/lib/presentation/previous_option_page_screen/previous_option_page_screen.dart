...
class PreviousOptionPageScreen extends StatelessWidget {
  const PreviousOptionPageScreen({super.key});
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Flexible(
            child: Text(
              "Choose any one analysis to view it's history",
    ...
    final List<Map<String, dynamic>> analysisOptions = [
      {
        ...
        "route": AppRoutes.batsmanTechniquePreviousButton,
      },
      {
        "text": "Timing Analysis",
        "image": ImageConstant.imganalysis2,
        "route": AppRoutes.timingPreviousButton,
      },
      {
        "text": "Body Stance\n& Footwork Analysis",
        "image": ImageConstant.imganalysis3,
        "route": AppRoutes.bodyStancePreviousButton,
      },
      {
        "text": "Batsman's Running\nSpeed Analysis",
        "image": ImageConstant.imganalysis4,
        "route": AppRoutes.runningSpeedPreviousButton,
      },
      {
        "text": "Bowling Speed\nAnalysis",
        "image": ImageConstant.imganalysis5,
        "route": AppRoutes.bowlingSpeedPreviousButton,
      },
      {
        "text": "Ball Placement\nAnalysis",
        "image": ImageConstant.imganalysis6,
        "route": AppRoutes.ballPlacementPreviousButton,
      }
    ];
